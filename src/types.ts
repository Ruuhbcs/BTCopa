...
export const BT_PLAYERS: Player[] = [
  ...
  },
  {
    ...
    description: "Atua como guardiã da experiência do cliente, garantindo que suas necessidades sejam ouvidas and plenamente atendidas."
  },
  {
    id: 5,
    name: "Ruth Barbosa",
  ...
  },
  {
    ...
    position: "Diretora Técnico de Clima",
    jerseyNumber: 99,
